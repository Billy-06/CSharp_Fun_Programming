...
public class Program
{
     ...
     * 
     * */
    public static void WorkingGenerics()
    {
        string jsonPerson = @"{
            ""Id"": 0045,
            ""FirstName"": ""Jack"",
    ...
    public static void WorkingCollections()
    {
        /**
         * Collections from System.Collections.ArrayList
         * 
         * 
         * */
        ...
        arrList.AddRange(new string[] { "Third", "Fourth", "Fifth" });

        Console.WriteLine($"The array has a size of: {arrList.Count}");
        ...
        CollectionSamples.GenericStack();
        CollectionSamples.GenericQueue();
        CollectionSamples.Indexing();
        CollectionSamples.Iterating();
        return;
    }

    public static void WorkingDictionaries()
    {
    ...
    public static void WorkingConcurrencies()
    {
